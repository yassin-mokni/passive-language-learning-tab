...
const radioStationsConfig = {
  ...
  tr: [
    {
      category: 'radio',
      title: 'Canlı Radyo (Türkçe Müzik & Yayın)',
      stations: [
        { id: 'radyo_fenomen_turk', name: 'Radyo Fenomen Türk' },
        { id: 'super_fm', name: 'Süper FM' },
        { id: 'virgin_radio_tr', name: 'Virgin Radio Türkiye' }
      ]
    },
    {
      category: 'radio',
      title: 'Canlı Radyo (Popüler & Dünya Müzikleri)',
      stations: [
        { id: 'radyo_fenomen', name: 'Radyo Fenomen' },
        { id: 'metro_fm', name: 'Metro FM' },
  ...
  it: [
    {
      category: 'radio',
      title: 'Radio in Diretta (Musica & Intrattenimento)',
      stations: [
        { id: 'radio_105', name: 'Radio 105 Network' },
        { id: 'rtl_1025', name: 'RTL 102.5' },
        { id: 'r101', name: 'R101 Italia' }
      ]
    },
    {
      category: 'radio',
      title: 'Notizie & Cultura (News & Talk)',
      stations: [
        { id: 'rai_radio2', name: 'Rai Radio 2' },
        { id: 'radio_armisa', name: 'Radio Armisa Italia' },
...
function getBackgroundUrlFromSeed(seed) {
  ...
  const index = Math.abs(hash) % UNSPLASH_WALLPAPER_IDS.length;
  const photoId = UNSPLASH_WALLPAPER_IDS[index];
  return `https://images.unsplash.com/photo-${photoId}?auto=format&fit=crop&w=1920&q=80`;
}
